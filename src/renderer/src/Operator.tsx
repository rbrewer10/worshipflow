...
// The operator control surface (Director view for Phase 0). Sends intents to the
// main process and mirrors the broadcast state — never holds authority itself.
function Operator(): JSX.Element {
  ...
  useEffect(() => {
    ...
    // Re-fetch once the main process has finished creating output windows.
        ...
        <div className="flex w-80 flex-col gap-3">
          ...
          <section className="rounded-xl border border-white/10 bg-white/[0.03] p-3">
            ...
            <div className="space-y-1 text-xs text-slate-400">
              ...
              {info && <div className="pt-1">Operator startup: <b className="text-slate-100">{info.startupMs} ms</b></div>}
            </div>
          </section>
        </div>
